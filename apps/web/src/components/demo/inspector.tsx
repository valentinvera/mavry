    ...
    <aside className="hidden min-h-0 border-border/80 border-l bg-transparent xl:flex xl:flex-col">
      <header className="flex items-center justify-between gap-3 border-border/80 border-b px-4 py-3">
        <div>
          ...
          <h2 className="mt-1 font-medium text-demo-body!">
            {pageContent.title}
          </h2>
        </div>
      ...
      <div className="min-h-0 flex-1 overflow-y-auto" data-smooth-scroll="">
        <section className="border-border/80 border-b px-4 py-4">
          <dl className="grid gap-3 text-demo-metadata!">
        ...
        <section className="border-border/80 border-b px-4 py-4">
          <div className="flex items-center gap-2">
            ...
            />
            <p className="font-medium text-demo-metadata!">Launch confidence</p>
          </div>
        ...
        <section className="border-border/80 border-b px-4 py-4">
          <p className="font-medium text-demo-metadata!">Next 3 actions</p>
          <div className="mt-3 divide-y divide-border/70">
            {[
              ...
              <button
                className="grid w-full grid-cols-[1rem_minmax(0,1fr)] gap-2 py-2 text-left text-demo-control! transition-colors hover:text-foreground active:translate-y-px"
                key={action}
                type="button"
              >
                <CheckIcon
        ...
        <section className="border-border/80 border-b px-4 py-4">
          <p className="font-medium text-demo-metadata!">Not in this MVP</p>
          <div className="mt-3 divide-y divide-border/70">
            {cutRows.map((row) => (
              <button
